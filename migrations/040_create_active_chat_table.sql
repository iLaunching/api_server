-- Migration 040: Create activeChat table (per-user Active Chat theme/avatar config)
-- Column types/FKs/defaults align with user_profiles appearance/avatar fields.
