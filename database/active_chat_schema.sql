-- Active Chat per-user theme/avatar configuration (mirrors user_profiles option columns)
...
CREATE INDEX IF NOT EXISTS idx_active_chat_avatar_display_option_id ON "activeChat"(avatar_display_option_id);
CREATE INDEX IF NOT EXISTS idx_active_chat_profile_icon_id ON "activeChat"(profile_icon_id);
CREATE INDEX IF NOT EXISTS idx_active_chat_avatar_color_id ON "activeChat"(avatar_color_id);
