"""
Migration Runner: 022_refine_protocol_display_text.sql
Purpose: Apply the refined display text migration
"""
...
async def migrate():
    ...
    try:
        ...
        migration_file = "migrations/022_refine_protocol_display_text.sql"
        ...
        for row in result:
            ...
            print(f"   {row['display_description'][:50]}...")
