...
COMMENT ON COLUMN user_profiles.synapse_number IS 'Unique public identifier for Ear Server and related routing (deprecated: moved to smart_hubs.synapse_number)';
