...
UserProfile.navigation = relationship("UserNavigation", back_populates="user_profile", uselist=False, foreign_keys="[UserNavigation.user_profile_id]")

# Update UserNavigation relationship to include back_populates
UserNavigation.user_profile = relationship("UserProfile", back_populates="navigation", foreign_keys="[UserNavigation.user_profile_id]")
